export default {
  ...
  ui: {
    ...
    panel_action: 'Klicken Sie, um das Seitenpanel zu öffnen',
    quality: 'Quality:',
  ...
  properties: {
    ...
    helvetica: 'Helvetica',
    times: 'times',
    prefs_and_content: 'Einstellungen und SVG-Inhalte lokal speichern',
    prefs_only: 'Einstellungen nur lokal speichern',
    no_prefs_or_content: 'Meine Einstellungen und SVG-Inhalte nicht lokal speichern',
    jgraduate_pad: 'Fortsetzen',
    jgraduate_reflect: 'Spiegeln',
    jgraduate_repeat: 'Wiederholen',
    id_label: 'id',
    class_label: 'klass',
  ...
  tools: {
    ...
    tool_source_dynamic: 'Dynamische Größenanpassung ein/ausschalten',
    ...
    ellipse_circle_tool: 'Ellipsen-/Kreiswerkzeug',
    square_rect_tool: 'Quadrat-/Rechteck-Werkzeug',
  ...
  config: {
    ...
    change_xxx_color: 'Ändere xxx Farbe',
    pick_paint_opavity: 'Pick a {{newValue}} Paint and Opacity',
    open_color_picker: 'Klicken, um Farbauswahl zu öffnen',
    jpicker_title: 'Ziehen Sie die Markierungen, um eine Farbe auszuwählen.',
    jpicker_new_color: 'neu',
    jpicker_current_color: 'aktuell',
    jpicker_tooltip_colors_new_color: 'New Color - Press &ldquo;OK&rdquo; To Commit',
    jpicker_tooltip_colors_current_color: 'Klicken, um zur Originalfarbe zurückzukehren',
    jpicker_tooltip_buttons_ok: 'Diese Farbauswahl übernehmen',
    jpicker_tooltip_buttons_cancel: 'Abbrechen und zur Originalfarbe zurückkehren',
    ...
    jgraduate_solid_color: 'Vollfarbe',
    jgraduate_linear_gradient: 'Linearer Farbverlauf',
    jgraduate_radial_gradient: 'Radialer Farbverlauf',
    jgraduate_begin_point: 'Start Punkt',
    jgraduate_enter_starting_x: 'Geben Sie den Start-X-Wert zwischen 0.0 und 1.0 ein',
    jgraduate_enter_starting_y: 'Geben Sie den Start-Y-Wert zwischen 0.0 und 1.0 ein',
    jgraduate_end_point: 'End Punkt',
    jgraduate_enter_ending_x: 'Geben Sie den End-X-Wert zwischen 0.0 und 1.0 ein',
    jgraduate_enter_ending_y: 'Geben Sie den End-Y-Wert zwischen 0.0 und 1.0 ein',
    jgraduate_center_point: 'Mittelpunkt',
    jgraduate_enter_value_x: 'Geben Sie einen X-Wert im Bereich von 0.0 bis 1.0 ein',
    jgraduate_enter_value_y: 'Geben Sie einen Y-Wert im Bereich von 0.0 bis 1.0 ein',
    jgraduate_focal_point: 'Brennpunkt',
    jgraduate_match_center: 'Zentrum anpassen:',
    jgraduate_enter_focal_x: 'Geben Sie einen X-Wert im Bereich von 0.0 bis 1.0 ein',
    jgraduate_enter_focal_y: 'Geben Sie einen Y-Wert im Bereich von 0.0 bis 1.0 ein',
    jgraduate_spread_method: 'Verteilungsmethode',
    jgraduate_radius: 'Radius:',
    jgraduate_set_radius: 'Klicken, um Radius festzulegen',
    jgraduate_ellip: 'Ellipse:',
    jgraduate_set_ellip: 'Klicken, um Ellipse festzulegen',
    jgraduate_angle: 'Winkel',
    jgraduate_set_angle: 'Klicken, um Winkel festzulegen',
    jgraduate_deg: 'deg:',
    jgraduate_opac: 'Transparenz:',
    jgraduate_set_opac: 'Klicken, um Transparenz festzulegen'
  },
  notification: {
